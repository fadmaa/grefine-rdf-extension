        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (rowIndex >= 0 && rowIndex < project.rows.size()) {
                    ...
                    result = Utils.evaluateExpression(project, expression, columnName, row, rowIndex); 
                }
                ...
                if (result == null) {
                	...
                	if (result.getClass().isArray()) {
                		...
                		for(int k=0;k<lngth;k++){
                			resolvedUrisVal.append(Utils.resolveUri(base,Array.get(result, k).toString()));
                			if(k<lngth-1){
                        ...
                        absolutes[i] = Utils.resolveUri(base,sb.toString());
                	}
                }
            }
            writer.endArray();
