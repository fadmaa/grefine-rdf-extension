...
you need to have the code of OpenRefine hhttps://github.com/OpenRefine/OpenRefine. Then pull the code of this extension into the extensions folder available with OpenRefine code. see https://github.com/OpenRefine/OpenRefine/wiki/Write-An-Extension
