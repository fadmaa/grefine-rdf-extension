...
RdfSchemaAlignmentDialog.prototype._createDialog = function() {
  ...
  frame.width("1000px"); // TODO set this based on screen dimensions?
...
RdfSchemaAlignmentDialog.prototype._editBaseUri = function(src){
  ...
  menu.html(
    '<div class="schema-alignment-link-menu-type-search"><input type="text" bind="newBaseUri" size="50"><br/>'+
